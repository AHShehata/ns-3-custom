...
double  maxRate_lower = maxRate_mbps * 1;
double lambda = 50.0; // Arrival rate: packets per second
...
double onTime = (payloadSize * 8.0)/maxRate_lower;
std::ostringstream onTimeStr1;
onTimeStr1  << onTime;
std::string onTimeString = "ns3::ConstantRandomVariable[Constant="+ onTimeStr1.str() +"]";

//double offTimeMean  = 1.0 / (maxRate_lower / (payloadSize*8)); // Mean inter-arrival time (time between packets)
double offTimeMean  = 1.0 / (lambda); // Mean inter-arrival time (time between packets)

std::ostringstream  offTimeStr1;
 offTimeStr1 << offTimeMean;
std::string offTimeString = "ns3::ExponentialRandomVariable[Mean="+ offTimeStr1.str() +"]";  
